...
if(isset($_POST['submit'])) {
    ...
    $ret = "SELECT student_email FROM student WHERE student_email=:email";
    ...
    if($query->rowCount() == 0) {
        $sql = "INSERT INTO student (name, student_email, Gender, Contact, Student_level, institution_id, Password) VALUES (:fullname, :email, :gender, :mobile, :level, :inputinstitution, :password)";
        ...
        if($lastInsertId) {
            $_SESSION['student_id'] = $lastInsertId;
