...
<html lang="en">
    <head>
        <title>Internship e-logbook Supervisor dashboard</title> 
        <!-- Required meta tags -->
        <meta charset="utf-8" />
        <meta
            name="viewport"
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
                  ...
                  <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                    ...
                    <div class="w3-container w3-row">
                        ...
                        <div class="w3-col s8 w3-bar">
                          <span>Welcome, <strong>Tricia</strong></span><br>
                    ...
                    <div class="offcanvas-body">
                      <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="Internship-e-logbook-forms/student/login.html"><i style="font-size:24px" class="fa">&#xf08b;</i> Logout</a>
                          </li>
                      </ul>
  ...
  <div class="w3-row-padding w3-margin-bottom">
    <div class="w3-quarter" style="width:33.3%">
